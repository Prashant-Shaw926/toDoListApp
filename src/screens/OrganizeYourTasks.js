...
export default function OrganizeYourTasks({navigation}) {
  return (
    <View style={styles.MYTContainer}>
      ...
      <View style={styles.midSection}>
        ...
        <View style={styles.midSectionTxtBox}>
          <View>
            <Text style={styles.midSectionTxtBox1}>Organize your tasks</Text>
          </View>
          <View>
            <Text style={styles.midSectionTxtBox2}>You can organize your daily tasks by adding your tasks into separate categories</Text>
          </View>
        </View>
      </View>
      <View style={styles.footer}>
        {/* <View><Pressable onPress={()=>navigation.navigate('CreateDailyRoutine')}><Text style={[styles.backTxt, styles.commonText]}>BACK</Text></Pressable></View> */}
